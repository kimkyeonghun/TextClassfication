...
class NewsParser(object):
    ...
    content_pattern = re.compile(
        r'본문 내용|TV플레이어|동영상 뉴스|   flash 오류를 우회하기 위한 함수 추가\nfunction  flash removeCallback     |tt|앵커 멘트|\xa0| 앵커 ')
    entertain_pattern = ["포토", "사진", "SNS", "뉴스엔TV",
                         "THE PHOTO", "화보", "영상", "TEN PHOTO"]
    ...
    def find_news_total_page(self, url):
        ...
        try:
            ...
            headline_tag = document_content.find(
                'div', {'class': 'paging'}).find('strong')
